import { average } from '../src/implementacao/5-average';
...
describe('mediaNotas', () => {
    test('caso [8, 7, 9], [5, 6, 5], [3, 4, 2]', () => {
        ...
        const resultado = average([8, 7, 9], [5, 6, 5], [3, 4, 2]);
    ...
    test('caso [9, 8, 7], [6, 5, 4], [2, 3, 2]', () => {
        ...
        const resultado = average([9, 8, 7], [6, 5, 4], [2, 3, 2]);
        expect(resultado).toEqual(esperado);
    ...
    test('caso [7, 7, 7], [4, 4, 4], [10, 9, 8]', () => {
        ...
        const resultado = average([7, 7, 7], [4, 4, 4], [10, 9, 8]);
        expect(resultado).toEqual(esperado);
